	...
	return (
		<Link
			...
			<div className="flex flex-col relative z-10 h-full p-4">
				...
				<p className="mt-2 text-sm lg:leading-6 line-clamp-2 lg:line-clamp-none">
					{block.p}
				</p>
				<div className="pt-4 mt-auto">
					<ButtonMain
						title={block.button.title}
						className={`w-full lg:w-auto mt-auto p-2 px-10 inline-flex justify-center bg-amber-400 rounded text-xs lg:text-sm ${block.button.className}`}
					/>
				</div>
			</div>
		</Link>
