export default function FooterHelp({ className }) {
	return (
		<div className={className}>
			...
			of the Product or on the date of delivery of the Product, whichever is
			...
			areintended for professional use.<strong>UTV:</strong> Cub Cadet Utility
			Vehicles (UTV) are intended foroff-road use by adults only. Please see the
			operator’s manual and thewarning labels posted on the vehicle itself for
			more details. <strong>Email disclaimer: </strong>Sign up to receive
			communication onservices, products and special offers. You may unsubscribe
			at any time.Please refer to our{" "}
			<a href="?oops=1#Click-the-Zero-Turn-Mowers-link-that-is-the-plp">
				Privacy Policy
			</a>
			.
		</div>
